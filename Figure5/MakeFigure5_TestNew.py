...
Ref_H2_Ama = CurrentTarget.nz_H2_ama
...
for i in range(NumMolecules):
    ...
    if i<NumMolecules-1:
        ...
        #if not(CurrentTarget.MoleculeNames[i]=="H2"):
        #    CurrentTarget.nz_H2_ama = Ref_H2_Ama*0.0
        #    print("Not H2")
        #else:
        #    CurrentTarget.nz_H2_ama = Ref_H2_Ama
        #    print("It is H2")
